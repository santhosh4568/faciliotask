    ...
    <div class="profile">
       <el-row class="row">
           <el-col :span="12" class="forms">
               ...
               <el-form  class="idform" ref="proform" :model="proform" label-width="120px">
                <el-form-item label="First Name">
                    <el-input  v-model="proform.firstname" @change="handleFirst" ></el-input>
                </el-form-item>
                <el-form-item label="Last Name">
                    <el-input v-model="proform.lastname" ></el-input>
                </el-form-item>
                <el-form-item label="Position">
                    <el-input v-model="proform.position" ></el-input>
                </el-form-item>
                <el-form-item label="Email">
                    <el-input v-model="proform.email" ></el-input>
                </el-form-item>
                <el-form-item label="D.O.J">
                  <el-date-picker format="dd-MM-yyyy" value-format="dd-MM-yyyy" :default-value="defaultdate" v-model="proform.doj" type="date" ></el-date-picker>
                </el-form-item>
                <el-form-item label="Contact">
                    <el-input v-model="proform.contact" ></el-input>
                </el-form-item>
           ...
           <el-col :span="12">
               ...
               <div class="idcard">
                    ...
                    <div class="bottom">
                        ...
                        <h4 class="dept1">NAME: {{proform.firstname}} {{proform.lastname}}</h4>
...
export default {
    ...
    methods:{
      ...
      handleSubmit(e)
      {
        ...
        this.$store.dispatch('setDefaultdatee',this.proform.defaultdate);
        this.$store.dispatch('setAttachment',this.proform.attachment);
